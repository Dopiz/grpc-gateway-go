...
func request_Greeter_SayHelloAgain_0(ctx context.Context, marshaler runtime.Marshaler, client GreeterClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq HelloAgainRequest
	var metadata runtime.ServerMetadata
...
var (
	pattern_Greeter_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"app", "v1", "SayHello"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Greeter_SayHelloAgain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"app", "v1", "SayHelloAgain"}, "", runtime.AssumeColonVerbOpt(true)))
)
